# API TP4 Mes Copains !
#### Zacharia Beddalia & Vaslin Pierre 
Le code ci-dessous est un fichier yaml pour swagger qui décrit l'api et permet de la tester

```yaml
swagger: "2.0"
info:
  description: "Description de l'API de l'application de blog. Vous pouvez changer les valeurs de 'host' et 'basePath' pour l'adapter à votre machine. Les autres valeurs ne doivent pas être modofiées.\n\n\n\nLe token de constant pour tester l'api 'token.pour.swagger'\n "
  version: "1.0.0"
  title: "Mes Copains !"
host: "192.168.75.87:8084"
basePath: "/api/v2/"
tags:
  - name: "groupes"
...
paths:
    ...
    post:
      ...
      parameters:
        - in: "body"
          ...
          required: true
          schema:
            $ref: "#/definitions/contentGroupe"
      responses:
        201:
          description: "Groupe cré"
        400:
  ...
  /groupes/{groupeId}:
    ...
    put:
      ...
      responses:
        204:
          description: "Groupe correctement cré ou modifié"
        400:
          description: "Pas de paramètres acceptables dans la requête"
        401:
          description: "Utilisateur non authentifié"
    ...
    post:
      ...
      parameters:
        ...
        - in: "body"
          ...
          required: true
          schema:
            $ref: "#/definitions/contentBillet"
        - $ref: "#/securityDefinitions/pseudo_auth"
      responses:
        201:
          description: "Billet cré"
        400:
          description: "Pas de paramètres acceptables dans la requête"
        401:
          description: "Utilisateur non authentifié"
  ...
  /groupes/{groupeId}/billets/{billetId}:
    ...
    put:
      ...
      responses:
        204:
          description: "Billet correctement cré ou modifié"
        400:
          description: "Pas de paramètres acceptables dans la requête"
        401:
          description: "Utilisateur non authentifié"
  ...
  /groupes/{groupeId}/billets/{billetId}/commentaires/{commentaireId}:
    ...
    put:
      ...
      responses:
        204:
          description: "Commentaire correctement cré ou modifié"
        400:
          description: "Pas de paramètres acceptables dans la requête"
        401:
          description: "Utilisateur non authentifié"
